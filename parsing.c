...
#define LARGSSERT(args, params) if (!(args->count == params)) { lval_del(args); return lval_err("Function passed too many arguments!");}
#define LASSERTEMTPY(args) if(!(args->count > 0)) {lval_del(args); return lval_err("Empty list passed!"); }
...
lval* builtin_cons(lval* a) {
  ...
  LASSERT(a, a->count == 2, "Function 'cons' too many arguments passed!");
